...
```
```{r, echo=FALSE}
cat("Mean for the total number of steps take per day: ", meansteps,"\n",
    "Median for the total number of steps take per day: ", mediansteps)
```
...
```
```{r, echo=FALSE}
cat("The total number of missing values (NAs): ", numna)
```
...
```
```{r, echo=FALSE}
cat(" Mean for the total number of steps take per day for new dataset:", meansteps2, "\n", 
    "Mean for the total number of steps take per day for original dataset:", meansteps, "\n",
    "Difference in mean:", as.integer(abs(meansteps - meansteps2)), "\n",
    "Median for the total number of steps take per day from new dataset:", mediansteps2, "\n",
    "Median for the total number of steps take per day from original dataset:", mediansteps, "\n",
    "Difference in median:", abs(mediansteps - mediansteps2))
```
